...
function setup() {
	...
	var y=300;
	 ...
	 leftBody = Bodies.rectangle(x-120,y-10, 20, 100 , {isStatic:true} );
	 World.add(world,leftBody);

	rightBody= Bodies.rectangle(x+80,y-8, 20, 100 , {isStatic:true} );
	 World.add(world, rightBody);
	 
	 baseBody = Bodies.rectangle(480,350, 200, 20 , {isStatic:true} );
